...
from ngiriapi.routing import Route, Router, WebSocketRoute
...
def test_exception_middleware_deprecation() -> None:
    ...
    with pytest.warns(DeprecationWarning):
        from ngiriapi.exceptions import ExceptionMiddleware  # noqa: F401

    with warnings.catch_warnings():
        warnings.simplefilter("error")
        import ngiriapi.exceptions

    with pytest.warns(DeprecationWarning):
        ngiriapi.exceptions.ExceptionMiddleware
