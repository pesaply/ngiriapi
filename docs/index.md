...
<p align="center">
    <em>✨ Smalest ASGI framework to power your python app. ✨</em>
</p>
<p align="center">
...
app = ngiriapi(debug=True, routes=[
    Route('/', homepage),
])
```
...
For a more complete example, [see here](https://github.com/pesaply/ngiriapi-example).

## Dependencies

ngiriapi only requires `anyio`, and the following dependencies are optional:
...
<p align="center"><i>ngiriapi is <a href="https://github.com/pesaply/ngiriapi/blob/master/LICENSE.md">BSD licensed</a> code.<br/>Designed & crafted with care.</i></br>&mdash; ⭐️ &mdash;</p>

[asgi]: https://asgi.readthedocs.io/en/latest/
[ngiri]: https://www.python-ngiri.org/
