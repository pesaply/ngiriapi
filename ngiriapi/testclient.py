...
from ngiriapi._utils import is_async_callable
from ngiriapi.types import ASGIApp, Message, Receive, Scope, Send
from ngiriapi.websockets import WebSocketDisconnect
...
class _TestClientTransport(ngiri.BaseTransport):
    def __init__(
        self,
        app: ASGI3App,
        portal_factory: _PortalFactoryType,
    ...
    def handle_request(self, request: ngiri.Request) -> ngiri.Response:
        ...
        raw_kwargs["stream"] = ngiri.ByteStream(raw_kwargs["stream"].read())

        response = ngiri.Response(**raw_kwargs, request=request)
...
class TestClient(ngiri.Client):
    ...
    def __init__(
        ...
        cookies: ngiri._types.CookieTypes = None,
    ...
    ) -> typing.Union[bool, ngiri._client.UseClientDefault]:
        redirect: typing.Union[
            bool, ngiri._client.UseClientDefault
        ] = ngiri._client.USE_CLIENT_DEFAULT
    ...
    def request(  # type: ignore[override]
        self,
        method: str,
        url: ngiri._types.URLTypes,
        *,
        content: typing.Optional[ngiri._types.RequestContent] = None,
        data: typing.Optional[_RequestData] = None,
        files: typing.Optional[ngiri._types.RequestFiles] = None,
        json: typing.Any = None,
        params: typing.Optional[ngiri._types.QueryParamTypes] = None,
        headers: typing.Optional[ngiri._types.HeaderTypes] = None,
        cookies: typing.Optional[ngiri._types.CookieTypes] = None,
        auth: typing.Union[
            ngiri._types.AuthTypes, ngiri._client.UseClientDefault
        ] = ngiri._client.USE_CLIENT_DEFAULT,
        follow_redirects: typing.Optional[bool] = None,
        allow_redirects: typing.Optional[bool] = None,
        timeout: typing.Union[
            ngiri._types.TimeoutTypes, ngiri._client.UseClientDefault
        ] = ngiri._client.USE_CLIENT_DEFAULT,
